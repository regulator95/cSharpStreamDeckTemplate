...
function refreshSettings(settings) {
    ...
    if (settings) {
        text_demo.value = unescape(settings.textDemoValue);
        if (text_demo.value == 'undefined') {
            text_demo.value = "";
        }
    }
...
function updateSettings() {
    ...
    setSettings.payload = {};
    setSettings.payload.textDemoValue = escape(text_demo.value);
    console.log(text_demo.value);
